...
from strategy_common_foundation_v1 import (  # noqa: E402
    BrokerOrderStatus,
    ContractError,
    CostRates,
    DryRunOrderPort,
...
class Captain2CommonFoundationTests(unittest.TestCase):
    def setUp(self):
        ...
        self.off_flag = Path(self.tempdir.name) / "strategy_01_off.flag"
    ...
    def test_off_flag_blocks_new_buy(self):
        ...
        self.assertEqual(decision.reason, "STRATEGY_OFF_FLAG")
