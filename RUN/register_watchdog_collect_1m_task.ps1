...
#
#  권한: 현재 사용자(LogonType Interactive, RunLevel Highest) — elevated 수집기 종료에 필요
# ════════════════════════════════════════════════════════════════════════
...
# ── Principal: 현재 사용자 (elevated 수집기 종료 권한 필요) ───────────
...
Write-Host "  Principal: $env:USERDOMAIN\$env:USERNAME (Interactive, Highest)"
