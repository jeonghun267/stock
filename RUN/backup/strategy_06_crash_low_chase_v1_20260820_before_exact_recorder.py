...
class Config:
    ...
    rebound_pct: float = float(os.environ.get("S06_REBOUND_PCT", "0.5"))
    ...
    chase_cap_pct: float = float(os.environ.get("S06_CHASE_CAP_PCT", "1.5"))
    entry_floor_pct: float = float(os.environ.get("S06_ENTRY_FLOOR_PCT", "0.5"))
    ...
    tp_pct: float = float(os.environ.get("S06_TP_PCT", "5.0"))
