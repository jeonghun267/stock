...
def _ipc_request_sort_key(path: Path) -> tuple[int, int, str]:
    ...
    try:
        ...
        modified = 0
    return (_IPC_REQUEST_PRIORITY.get(request_type, 5), modified, path.name)
    ...
    def process_request(self, req_path: Path):
        ...
        try:
            ...
            if req_type == "PING":
                ...
                if self._ipc_auth_ok(request_id, req, "TR", "SEC-TR-AUTH"):
                ...
                if self._ipc_auth_ok(request_id, req, "ACCOUNT_INFO",
                                     "SEC-ACCOUNTINFO-AUTH"):
                    self._handle_account_info_request(request_id, req)
            elif req_type == "BALANCE_TR":
                if self._ipc_auth_ok(request_id, req, "BALANCE_TR",
                                     "SEC-BALANCETR-AUTH"):
                ...
                if self._ipc_auth_ok(request_id, req, "BATCH_TR",
                                     "SEC-BATCHTR-AUTH"):
