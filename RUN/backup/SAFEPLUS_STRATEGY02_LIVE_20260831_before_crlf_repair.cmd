...
REM Owner-approved permanent loss re-entry gate: 15m + lower low + 3 buy-side confirmations.
set S02_LOSS_REENTRY_GATE_MODE=SHADOW
set S02_LOSS_REENTRY_WAIT_SEC=900
set S02_LOSS_REENTRY_CONFIRMATIONS=3
