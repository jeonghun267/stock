...
class Config:
    ...
    #   S06_UNIVERSE_MODE=BOARD 면 고저폭판 ∩ 돈흐름 선별판의 던짐/매도세만
    #   관찰한다. SNAPSHOT(기본)이면 종전대로 스냅샷 전체.
    #   되돌리기: backup\strategy_06_crash_low_chase_v1_20260826_before_board_universe.py
...
class Strategy06Engine:
    ...
    def _universe(self, now: datetime) -> Tuple[list, str]:
        ...
        # ★[BOARD-UNIVERSE 2026-08-26 친구님 지시] BOARD 모드는 고저폭 후보이면서
        #   돈흐름 선별판의 던짐/매도세인 종목만 본다. 나머지 매수 조건은 그대로다.
