...
REM ============================================================================
C:\python310\python.exe -B -X utf8 C:\stock_bot\RUN\rotate_runtime_file_v1.py --max-mb 256 --archive-root C:\stock_bot\archive_runtime --path C:\stock_bot\data\micro_rank_history.csv --path C:\stock_bot\data\LOG\micro_rank_engine.log --path C:\stock_bot\data\LOG\sched_MICRO_RANK.log
