...
SIGNAL_REQUIRED = (
    ...
    "rebound_pct", "action", "reason", "signal_ts", "signal_price", "prod_sha",
)
PRE_STATE_REQUIRED = ("anchor_low", "anchor_low_ts", "chase_blocked", "emitted")
ENGINE_REQUIRED = (
    ...
    "early_low_live_enabled", "contract_pass", "selector_pass", "prod_sha",
)
...
def _replay_engine_record(
    ...
    return None, _run_selector(True)
